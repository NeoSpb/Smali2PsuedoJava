...
public class SmaliMethod {
    ...
    public SmaliMethod(ArrayList<String> methodChunk) {
        ...
        ARRAY_DATA = new HashMap<>();
        PSWITCHES = new HashMap<>();
        SSWITCHES = new HashMap<>();
        ...
        for (int i = 0; i < methodChunk.size(); i++) {
            ...
            if (!(line.startsWith(".restart local") || line.startsWith(".end local")))
            ...
            if (i == 0) {
                ...
                if (line.startsWith(".parameter")) {
                    ...
                    if (line.startsWith(".parameter")) {
                        line = "noname" + (this.PARAM_NAMES.size() + 1);
                    } else {
                ...
                // Handle Annotations
                    ...
                    ArrayList<String> annoChunk = new ArrayList<>();
                    annoChunk.add(line);
                ...
                // Handle Packed-Switches
                    ...
                    ArrayList<String> switchChunk = new ArrayList<>();
    ...
    public void writeToFile(BufferedWriter writer) throws IOException {
        if (this.NAME == null || this.SCOPE == null || this.RETURNTYPE == null)
            Utils.writeLine(writer, "METHOD FORMAT WRONG!!", 1);
        else {
            // HEADER Portion
    ...
    protected String processCodeLine(String line, BufferedWriter writer, int index) throws IOException {
        ...
        else if (line.startsWith("add-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "+", false);
        else if (line.startsWith("sub-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "-", false);
        else if (line.startsWith("mul-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "*", false);
        else if (line.startsWith("div-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "/", false);
        else if (line.startsWith("rem-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "%", false);
        else if (line.startsWith("and-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "&", false);
        else if (line.startsWith("or-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "|", false);
        else if (line.startsWith("xor-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "^", false);
        else if (line.startsWith("shl-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "<<", false);
        else if (line.startsWith("shr-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), ">>", false);
        else if (line.startsWith("ushr-int/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), ">>>", false);
        else if (line.startsWith("add-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "+", true);
        else if (line.startsWith("sub-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "-", true);
        else if (line.startsWith("mul-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "*", true);
        else if (line.startsWith("div-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "/", true);
        else if (line.startsWith("rem-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "%", true);
        else if (line.startsWith("and-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "&", true);
        else if (line.startsWith("or-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "|", true);
        else if (line.startsWith("xor-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "^", true);
        else if (line.startsWith("shl-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "<<", true);
        else if (line.startsWith("shr-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), ">>", true);
        else if (line.startsWith("ushr-long/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), ">>>", true);
        else if (line.startsWith("add-float/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "+", false);
        else if (line.startsWith("sub-float/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "-", false);
        else if (line.startsWith("mul-float/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "*", false);
        else if (line.startsWith("div-float/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "/", false);
        else if (line.startsWith("rem-float/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "%", false);
        else if (line.startsWith("add-double/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "+", true);
        else if (line.startsWith("sub-double/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "-", true);
        else if (line.startsWith("mul-double/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "*", true);
        else if (line.startsWith("div-double/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "/", true);
        else if (line.startsWith("rem-double/2addr"))
            return s2pj_Arithmetic2Address(Utils.removeFirstWord(line), "%", true);
        ...
        else if (line.startsWith("int-to-float"))
            return s2pj_ToType(Utils.removeFirstWord(line), "float", false, false);
        else if (line.startsWith("int-to-double"))
            return s2pj_ToType(Utils.removeFirstWord(line), "double", false, true);
        else if (line.startsWith("long-to-int")) return s2pj_ToType(Utils.removeFirstWord(line), "int", true, false);
        else if (line.startsWith("long-to-float"))
            return s2pj_ToType(Utils.removeFirstWord(line), "float", true, false);
        else if (line.startsWith("long-to-double"))
            return s2pj_ToType(Utils.removeFirstWord(line), "double", true, true);
        ...
        else if (line.startsWith("float-to-double"))
            return s2pj_ToType(Utils.removeFirstWord(line), "double", false, true);
        ...
        else if (line.startsWith("double-to-float"))
            return s2pj_ToType(Utils.removeFirstWord(line), "float", true, false);
        ...
        else if (line.startsWith("int-to-short"))
            return s2pj_ToType(Utils.removeFirstWord(line), "short", false, false);
        ...
        else if (line.startsWith(":try_start")) {
            if (writer != null) Utils.writeLine(writer, s2pj_TryStart(line), 2);
            return "";
        } else if (line.startsWith(":try_end")) {
            if (writer != null) Utils.writeLine(writer, s2pj_TryEnd(line), 2);
            return "";
        } else if (line.startsWith(".catchall")) {
            if (writer != null) Utils.writeLine(writer, s2pj_CatchAll(Utils.removeFirstWord(line)), 2);
            return "";
        } else if (line.startsWith(".catch")) {
            if (writer != null) Utils.writeLine(writer, s2pj_Catch(Utils.removeFirstWord(line)), 2);
            return "";
        } else if (line.startsWith(":")) {
            if (writer != null) Utils.writeLine(writer, s2pj_GotoTag(line), 1);
            return "";
        } else {
    ...
    private String s2pj_InvokeMethod(String line, boolean isStatic, boolean isSuper) {
        ...
        StringBuilder outArguments = new StringBuilder();
        ...
        if (args.size() != expectedArgSize)
            outArguments = new StringBuilder("OMG!! Num of arguments and argument types does not match!!!");
        else {
            for (int i = 0; i < argsTypes.size(); i++) {
                ...
                outArguments.append(getVarName(arg));
                if (i != argsTypes.size() - 1) outArguments.append(", ");
            }
        }
        outArguments = new StringBuilder("(" + outArguments + ")");
    ...
    private String s2pj_MoveResult(String line) {
        return line + " = ";
    }
    ...
    private String s2pj_Const(String line) {
        ...
        if (modeparts.length > 1) {
            String mode = modeparts[1];
            if (mode.compareTo("4") == 0 || mode.compareTo("16") == 0) {
            } // Do nothing
            else if (mode.compareTo("high16") == 0) paddingmode = Utils.PADDING_BEHIND;
            else return "[ERROR] const-wide Unknown Mode!!!";
        }
    ...
    private String s2pj_Compare(String line, String bias) {
        ...
        else if (bias.equals("l"))
            out += "if ( (" + src1 + " is NaN) || (" + src2 + " is NaN) ) " + dest + " = -1;\nelse ";
    ...
    private String s2pj_MoveException(String line) {
        return line + " = " + "Thrown Exception";
    }

    private String s2pj_MethodClosing() {
        return "}";
    }

    private String s2pj_ReturnVoid() {
        return "return;";
    }

    private String s2pj_ReturnObject(String line) {
        return "return " + getVarName(line.trim()) + ";";
    }

    private String s2pj_GotoTag(String line) {
        return "" + line;
    }

    private String s2pj_Goto(String line) {
        return "goto " + line;
    }

    private String s2pj_Throw(String line) {
        return "throw " + getVarName(line.trim()) + ";";
    }

    private String s2pj_MonitorEnter(String line) {
        return "Monitor-Enter " + getVarName(line.trim());
    }

    private String s2pj_MonitorExit(String line) {
        return "Monitor-Exit " + getVarName(line.trim());
    }
    ...
    private String s2pj_FillArrayData(String line) {
        ...
        for (int i = 0; i < arrData.DATA.size(); i++) {
            ...
            out.append("0x").append(dataOut);
            if (i != arrData.DATA.size() - 1) out.append(", ");
        }
        out.append("};");
        return out.toString();
    }
    ...
    private String s2pj_PackedSwitch(String line) {
        ...
        StringBuilder out = new StringBuilder("switch (" + src + "){\n");
        long startval = pSwitch.STARTVAL;
        for (int i = 0; i < pSwitch.SWITCHES.size(); i++) {
            String sw = pSwitch.SWITCHES.get(i);
            out.append("\tcase ").append(startval + i).append(" : goto ").append(sw).append("\n");
        }
        out.append("}");
        return out.toString();
    }
    ...
    private String s2pj_SparseSwitch(String line) {
        ...
        for (int i = 0; i < sSwitch.KEYS.size(); i++) {
            ...
            out.append("\tcase ").append(key).append(" : goto ").append(value).append("\n");
        }
        out.append("}");
        return out.toString();
    }
